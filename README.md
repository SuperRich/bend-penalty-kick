...
A 2D penalty shootout. You aim and shoot. A simple AI keeps and takes. Best of 5 kicks each side.
...
5. You and the AI each take up to 5 kicks. The match ends early when the other side cannot catch up.
